...
namespace Taste.Pages.Customer.Cart
{
    public class SummaryModel : PageModel
    {
        ...
        public IActionResult OnGet()
        {
            ...
            IEnumerable<ShoppingCart> cart = _unitOfWork.ShoppingCart.GetAll(c => c.ApplicationsUserId == claim.Value);
        ...
        public IActionResult OnPost(string stripeToken)
        {
            ...
            detailCart.listCart = _unitOfWork.ShoppingCart.GetAll(c => c.ApplicationsUserId == claim.Value).ToList();
