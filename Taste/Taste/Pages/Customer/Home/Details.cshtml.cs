    ...
    public class DetailsModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            if (ModelState.IsValid)
            {
                ...
                ShoppingCartObj.ApplicationsUserId = claim.Value;

                ShoppingCart cartFromDb = _unitOfWork.ShoppingCart.GetFirstOrDefault(c => c.ApplicationsUserId == ShoppingCartObj.ApplicationsUserId &&
                ...
                var count = _unitOfWork.ShoppingCart.GetAll(c => c.ApplicationsUserId == ShoppingCartObj.ApplicationsUserId).ToList().Count;
